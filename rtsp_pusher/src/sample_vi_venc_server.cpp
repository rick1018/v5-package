...
int main(int argc, char **argv)
{
    ...
    if ((ret = avformat_alloc_output_context2(&octx, NULL, "rtsp", outUrl) < 0)){
    ...
    if (octx->pb == NULL) printf("ffmpeg avio_open.\n"); 

    if ((ret = avformat_write_header(octx, NULL)) < 0)printf("ffmpeg avformat_write_header.\n");
