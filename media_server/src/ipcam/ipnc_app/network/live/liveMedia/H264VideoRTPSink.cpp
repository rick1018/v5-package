...
extern int os_mac;
extern int is_ssm; // add by kenny chiu 20120809
...
H264FUAFragmenter::H264FUAFragmenter(UsageEnvironment& env,
  ...
  : FramedFilter(env, inputSource),
	...
	fSPS = new unsigned char[fInputBufferSize]; //modify by alice 
	fPPS = new unsigned char[fInputBufferSize]; //modify by alice 
}
...
void H264FUAFragmenter::doGetNextFrame()
{
	...
	{
//alice_modify_onvif_2012_4_26_v1
		//if (os_mac || !is_ssm)
		if (1)  // modify by kenny chiu 20120919
		{
		...
		else
		{
			...
			//printf("fLastFragmentCompletedNALUnit = %d \n", fLastFragmentCompletedNALUnit);
			// Complete delivery to the client:
			FramedSource::afterGetting(this);
		}	
	//alice_modify_onvif_2012_4_26_v1
