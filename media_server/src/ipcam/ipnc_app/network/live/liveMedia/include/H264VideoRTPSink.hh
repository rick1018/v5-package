...
private:
  ...
  unsigned char* fSPS; //modify by alice 
  unsigned fSPSSize;  //modify by alice 
  unsigned char* fPPS;  //modify by alice 
  unsigned fPPSSize;  //modify by alice 
  unsigned fNumValidDataBytes;
  unsigned fCurDataOffset;
  unsigned fSaveNumTruncatedBytes;
  Boolean fLastFragmentCompletedNALUnit;
  Boolean sentSPS;  //modify by alice 
  Boolean sentPPS;  //modify by alice 
