...
int GetWifiE2PData(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.cmd = SYS_MSG_GET_WIFI_E2P_Data;
	SemWait(hndlDrvSem);
...
int GetWifiNandFlashCNData(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_WIFI_NandFlashCN_Data;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetNETConnectValue(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_NET_CONNECNT;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetNETSitesurvey(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_NET_SITESURVEY;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetNETSitesurveyNUM(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_NET_SITESURVEYNUM;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
//alice_modify_2012_3_27_v1
//alice_modify_2012_5_10_v1
int GetNETRSSI(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_NET_RSSI;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetHttpPort(void *data, unsigned int len)
{
	...
	SemWait(hndlDrvSem);
	msgsnd( gSysMsgId,&msgbuf,sizeof(msgbuf)-sizeof(long),0);/*send msg1*/
//    fprintf(stderr,"%s,%s:%d\n",__FILE__,__func__,gSysMsgId);
//	msgrcv( gSysMsgId, &msgbuf,sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	while( (msgrcv( gSysMsgId, &msgbuf,sizeof(msgbuf)-sizeof(long), msgbuf.src, IPC_NOWAIT) < 0)  && (timeout++ < 3))
	{
...
/**
* @brief get update mode.  by Larry
...
* @retval -1 Fail.
*/
int GetUpdateMode(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_UPDATE_MODE;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetTitle(void *data, unsigned int len)
{
	...
	if (msgbuf.length > 0)
		ShareMemRead(msgbuf.offset, buf, msgbuf.length);
...
/**
* @brief get SNTP server FQDN.
* @ Reducing Code Size,RS
* @param data [ O] pointer to data  buffer.
* @param len [I ] data buffer length.
* @retval 0 Success.
* @retval -1 Fail.
*/
int GetCMD(void *data, unsigned int len,int cmd) //RS,MDY
{
	SYS_MSG_BUF msgbuf;
	int length;
	memset(&msgbuf, 0, sizeof(msgbuf));
...
* @retval -1 Fail.
*/
int GetPtzSpeed(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_SPEED;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
* @retval -1 Fail.
*/
int GetPatrolList(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PATROL_LIST;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
* @retval -1 Fail.
*/
int GetPtzInfo(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_INFO;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetPtzPos(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_POS;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
//
int GetPtzMVStatus(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_MVStatus;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetPtzPresetList2(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_LIST2;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
//alice_modify_onvif_code_2011
/**
* @brief get PTZ Preset List //by Larry
...
* @retval -1 Fail.
*/
int GetPtzPresetList(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length;
	char *pBuf;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_LIST;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
* @retval -1 Fail.
*/
int GetZoomValue(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_ZOOM_VALUE;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
* @retval -1 Fail.
*/
int GetPtzHome(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_PTZ_HOME;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
* @retval -1 Fail.
*/
int GetGPI1Status(void *data, unsigned int len)
{
	char buf[256] = "";
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_GPI1_STATUS;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int GetGPI2Status(void *data, unsigned int len)
{
	char buf[256] = "";
	SYS_MSG_BUF msgbuf;
	int length;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_GPI2_STATUS;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
* @retval -1 Fail.
*/
int GetGPOStatus(void *data, unsigned int len)
{
	char buf[256] = "";
	SYS_MSG_BUF msgbuf;
	int length;
	...
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_GPO_STATUS;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
/**
* @brief set Secondary DNS.

* @param data [I ] pointer to input data.
* @param len [I ] data length.
* @return message buffer length.
*/
int SetDns2(void *data, unsigned int len)
{
   SYS_MSG_BUF msgbuf;
   memset(&msgbuf,0,sizeof(msgbuf));
   msgbuf.Des = MSG_TYPE_MSG1;
   msgbuf.src = gSysProcId;
   msgbuf.cmd = SYS_MSG_SET_DNS2;
   msgbuf.length = len;
   msgbuf.offset = (gSysProcId - MSG_TYPE_MSG1 - 1) * PROC_MEM_SIZE;
   SemWait(hndlDrvSem);
   ShareMemWrite(msgbuf.offset, data, len);
...
* @return message buffer length.
*/
int GetRftpEnable(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	int length, ret = 0;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_GET_FTP_RFTPENABLE;
	SemWait(hndlDrvSem);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
	msgrcv(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), gSysProcId, 0);
	length = len;
...
int SetSysSet(void *data, unsigned int len, int cmd ,int offset)  //RS 0504 // modify by Joseph 20131212
{
	SYS_MSG_BUF msgbuf;
	memset(&msgbuf, 0, sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	...
	msgbuf.cmd = cmd;
	msgbuf.length = len;
	msgbuf.offset = ((gSysProcId - MSG_TYPE_MSG1 - 1) * PROC_MEM_SIZE) + offset; //modify by Joseph 20131212
	//msgbuf.offset = (gSysProcId - MSG_TYPE_MSG1 - 1) * PROC_MEM_SIZE;
	SemWait(hndlDrvSem);
	ShareMemWrite(msgbuf.offset, data, len);
	msgsnd(gSysMsgId, &msgbuf, sizeof(msgbuf)-sizeof(long), 0);/*send msg1*/
...
// IVS_FEATURE, Add by Dean
int GetSysSet(void *data, unsigned int len, int cmd)
{
	char buf[256] = "";
	SYS_MSG_BUF msgbuf;
	int length;
...
#if 0 //RS,RDY,NON-USED FOR DM365
...
int SetSysMPEG43Res(void *data, unsigned int len)
{
	SYS_MSG_BUF msgbuf;
	memset(&msgbuf,0,sizeof(msgbuf));
	msgbuf.Des = MSG_TYPE_MSG1;
	msgbuf.src = gSysProcId;
	msgbuf.cmd = SYS_MSG_SET_MPEG43_RES;
	msgbuf.length = len;
	msgbuf.offset = (gSysProcId - MSG_TYPE_MSG1 - 1) * PROC_MEM_SIZE;
	SemWait(hndlDrvSem);
	ShareMemWrite(msgbuf.offset, data, len);
