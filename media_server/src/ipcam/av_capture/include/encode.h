...
int GetDrawLogoStatus(void);//RS,20100302
int GetDrawTextStatus(void);//RS,20100302

void SetROICfgEnable(int enable);

void VIDEO_streamSetAdvFeature( int type, unsigned int enMask );
void video_frameRate_setparm( int type, int frameRate );
void video_GOP_setparm( int gop);//Add by Joseph 20131118
void video_set_motion_src( int setval );
void VIDEO_setIrisMode( int setval );
...
void VIDEO_motion_setparm(void);
