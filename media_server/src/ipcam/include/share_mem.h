...
#define PROC_MEM_SIZE 4096*2 //reduce the memory size by frank.
#define MAX_SHARE_PROC	MSG_TYPE_END //modify by frank, reserved for more application can communication with system_server.
/**
* @ingroup UTILITY API
