...
int GetCMD(void *data, unsigned int len,int cmd);//RS,ADD
...
int SetSysSet(void *data, unsigned int len,int cmd,int offset) ;//RS,MDY //Modify by Joseph 20131212
int GetSysSet(void *data, unsigned int len,int cmd) ;	// IVS_FEATURE, Add by Dean
...
int GetRftpEnable(void *data, unsigned int len); //by Larry
int GetNETConnectValue(void *data, unsigned int len);//alice_modify_2012_3_15_v1
...
//int GetPtzSpeed(void *data, unsigned int len);			//by Larry
//int GetPtzInfo(void *data, unsigned int len);			//by Larry
//int GetPtzList(void *data, unsigned int len);			//by Larry
//int GetPatrolList(void *data, unsigned int len);		//by Larry
//int GetZoomValue(void *data, unsigned int len);			//by Larry
int GetGPI1Status(void *data, unsigned int len);			//by Larry
int GetGPI2Status(void *data, unsigned int len);			//by Larry
int GetGPOStatus(void *data, unsigned int len);			//by Larry
//int GetPtzHome(void *data, unsigned int len);			//by Larry
