...
#define RET_OVERWRITE       -102	/**< error code : request data loss */
...
#define AV_OP_WAIT_NEW_PCM_SERIAL			25 /**< Get new AUDIO serial number with wait (do not use now)*/

#define AV_OP_LOCK_PCM 	 			  34 /**< Lock a period of sound PCM */
#define AV_OP_UNLOCK_PCM 			  35 /**< Unlock a period of sound PCM */
#define AV_OP_GET_PCM_SERIAL 		  36 /**< Get latest AUDIO PCM serial number */

#define AV_OP_LOCK_H264_VOL 		  40 /**< Lock VOL of H264 */
#define AV_OP_UNLOCK_H264_VOL 		  41 /**< Unlock VOL of H264 */
#define AV_OP_LOCK_H264 			  42 /**< Lock one H264 frame */
#define AV_OP_LOCK_H264_IFRAME 		  43 /**< Lock one H264 I frame*/
#define AV_OP_UNLOCK_H264 			  44 /**< Unlock one MPEG4 frame */
#define AV_OP_GET_H264_SERIAL 		  45 /**< Get latest H264 serial number */
#define AV_OP_WAIT_NEW_H264_SERIAL    46 /**< Get new H264 serial number with wait (do not use now)*/
...
typedef struct _av_data
{
	...
	int quality;	/**< frame quality */
	int flags;		/**< frame flags */
	int frameType;	/**< either AV_FRAME_TYPE_I_FRAME  or AV_FRAME_TYPE_P_FRAME */
