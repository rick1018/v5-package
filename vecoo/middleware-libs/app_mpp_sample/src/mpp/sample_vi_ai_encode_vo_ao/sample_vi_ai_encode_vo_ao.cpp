...
#endif
{
    ...
    printf("\033[2J");
    printf("\n\n\nDo sample [vi+venc+vo]+[ai+aenc+ao]+rtsp.\n");
    printf("default:VI_4K@25fps+VENC(4K@25fps+720P@25fps) H264/CBR/MainProfile \n");
    printf("        Audio AAC 16bit 16K MONO \n");
    ...
    if (ret)
    {
        ERR_PRT("Do ao_create fail! ret:%d \n", ret);
        goto _exit_6;
    }
