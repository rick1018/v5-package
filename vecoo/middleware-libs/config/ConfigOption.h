...
//option for MPPCFG_ISE_BI
#define OPTION_ISE_BI_ENABLE     (1)
#define OPTION_ISE_BI_DISABLE    (0)

//option for MPPCFG_ISE_BI_SOFT
#define OPTION_ISE_BI_SOFT_ENABLE     (1)
#define OPTION_ISE_BI_SOFT_DISABLE    (0)

//option for MPPCFG_ISE_STI
#define OPTION_ISE_STI_ENABLE    (1)
#define OPTION_ISE_STI_DISABLE   (0)
...
// option for MPPCFG_VIDEOSTABILIZATION
#define OPTION_VIDEOSTABILIZATION_ENABLE  (1)
#define OPTION_VIDEOSTABILIZATION_DISABLE (0)
