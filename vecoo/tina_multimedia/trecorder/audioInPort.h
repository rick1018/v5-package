...
static int alsaAportInit(void *hdl,int enable,int format,int samplerate,int channels,int bitrate)
{
	aInPort *hdlAudio = (aInPort *)hdl;
...
static int alsaAportGetAudioBitrate(void *hdl)
{
	aInPort *hdlAudio = (aInPort *)hdl;
	if(hdlAudio == NULL)
		return -1;
	return hdlAudio->bitRate;
}
...
static int alsaAportSetAudioBitrate(void *hdl,int bitrate)
{
	aInPort *hdlAudio = (aInPort *)hdl;
	if(hdlAudio == NULL)
		return -1;
