...
** v2.0.0	leo@2013/09/11: redefine pmmlib_getAlcBufferFromPhyAddr();
** v3.0.0   leo@2013/11/14: add interfaces to support buffer safe-releaseto avoid mmu pagefault, and dump() interface.
**
*****************************************************************************/ 
...
//
//
#define PMM_VER_MAJOR   3
#define PMM_VER_MINOR   0
#define PMM_VER_PATCH   0
#define PMM_VER_STRING  "3.0.0"
...
//#############################################################################
IM_UINT32 pmmlib_version(OUT IM_TCHAR *verString);
...
IM_RET pmmlib_dmmu_lock_devaddr(IN pmm_handle_t handle, IN IM_UINT32 devaddr);
IM_RET pmmlib_dmmu_unlock_devaddr(IN pmm_handle_t handle, IN IM_UINT32 devaddr);
...
// simple tools
IM_RET pmmlib_getAlcBufferFromPhyAddr(IN pmm_handle_t handle, IN IM_UINT32 phyAddr, OUT alc_buffer_t *alcBuffer);

IM_INT32 pmmlib_dump(IN IM_TCHAR *buffer, IN IM_INT32 size);
