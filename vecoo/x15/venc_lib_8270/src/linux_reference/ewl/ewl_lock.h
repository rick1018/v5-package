 ...
 * to protect 7280 hardware resource. Using shared memory to poll
 * for correspond mark.
 *
...
#ifndef __EWL_LOCK_H__
#define __EWL_LOCK_H__
...
#define EWL_LOCK_MARK			0x12345678
#define EWL_LOCK_SIZE			(4 * 1024)
#define EWL_LOCK_KEY			(0x72809170)
