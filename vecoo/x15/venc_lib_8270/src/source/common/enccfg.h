 ...
 * 1 = 64-bit endianess */
#ifndef ENC8270_INPUT_SWAP_32_RGB16
#define ENC8270_INPUT_SWAP_32_RGB16                 1
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB16
 */
#ifndef ENC8270_INPUT_SWAP_16_RGB16
#define ENC8270_INPUT_SWAP_16_RGB16                 1
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB16
 */
#ifndef ENC8270_INPUT_SWAP_8_RGB16
#define ENC8270_INPUT_SWAP_8_RGB16                  0
#endif

/* The input image's 32-bit swap: 0 or 1
 * This defines the 32-bit endianess of the ASIC input RGB32
 * 1 = 64-bit endianess */
#ifndef ENC8270_INPUT_SWAP_32_RGB32
#define ENC8270_INPUT_SWAP_32_RGB32                 1
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB32
 */
#ifndef ENC8270_INPUT_SWAP_16_RGB32
#define ENC8270_INPUT_SWAP_16_RGB32                 0
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB32
 */
#ifndef ENC8270_INPUT_SWAP_8_RGB32
#define ENC8270_INPUT_SWAP_8_RGB32                  0
#endif

/* ENC8270_OUTPUT_SWAP_XX define the byte endianess of the ASIC output data.
 ...
 */
#ifndef ENC8270_IRQ_DISABLE
#define ENC8270_IRQ_DISABLE                         0
#endif
...
#ifndef ENC8270_TIMEOUT_INTERRUPT
#define ENC8270_TIMEOUT_INTERRUPT                          1
#endif


// Leo@2011/10/22: add
#define VIDEOSTAB_ENABLED
