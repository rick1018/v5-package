...
#define H264ENCSTRMENCODE_MAX_BUF       0xFFFFFF
                                   ...
                                   const H264EncPreProcessingCfg * pPreProcCfg)
{
    ...
    /* check HW limitations */
    {
           ...
           pPreProcCfg->videoStabilization != 0)
        {
            ...
            return H264ENC_INVALID_ARGUMENT - __LINE__ * 100;
        }
                             ...
                             H264EncOut * pEncOut)
{
    ...
    if((!H264_BUS_ADDRESS_VALID(pEncIn->busOutBuf)) ||
       ...
       (pEncIn->outBufSize > H264ENCSTRMENCODE_MAX_BUF) ||
