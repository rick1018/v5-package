...
test_set() {
    ...
    if [ ${valid[${set_nro}]} -eq -1 ]; then
	    ...
	    then
	        ...
	        mv stream.h264 ${TESTDIR}/case_${case_nro}/case_${case_nro}.h264
		#mv case_${case_nro}.time random_cases/case_${case_nro}.time
	    else
	        mv stream.h264 case_${case_nro}/case_${case_nro}.h264
		cp encoder_h264.log case_${case_nro}/case_${case_nro}.log
	    fi
