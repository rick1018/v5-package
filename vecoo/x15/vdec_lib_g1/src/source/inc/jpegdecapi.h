...
#define INFOTM_SUPPORT_EXTRA_THUMBNAIL 
#define INFOTM_JPEG_FIND_MARK
/*------------------------------------------------------------------------------
    3. Data types
------------------------------------------------------------------------------*/
    ...
    enum
    {
        ...
        JPEGDEC_THUMBNAIL_NOT_SUPPORTED_FORMAT = 0x14
#else
	 JPEGDEC_THUMBNAIL_JPEG = 0x10,
...
/* Image information */
    typedef struct
    {
        ...
        u32 codingModeThumb;    /* JPEGDEC_BASELINE
                                 ...
                                 */
#ifdef INFOTM_SUPPORT_EXTRA_THUMBNAIL
	u8 *pThumbnailDataVirtual;
	u32 pThumbnailDataBus;
#endif
...
/* Decode JFIF */
    ...
    JpegDecRet JpegDecMMUEnable(JpegDecInst decInst,
                             int mmu_enable);
/*------------------------------------------------------------------------------
