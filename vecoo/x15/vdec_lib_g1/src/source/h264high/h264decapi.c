...
/*------------------------------------------------------------------------------
    ...
    Function: H264DecMMUEnable()

        Functional description:
            This function configures decoder to use buffer allocated through mmu
...
------------------------------------------------------------------------------*/
H264DecRet H264DecMMUEnable(H264DecInst decInst, int mmu_enable)
{
    decContainer_t *pDecCont = (decContainer_t *) decInst;
