...
#define HX170DEC_MUTEX_LOCK        _IOW(HX170DEC_IOC_MAGIC, 7, int)
#define HX170DEC_MUTEX_UNLOCK      _IO(HX170DEC_IOC_MAGIC,  8)
#define HX170DEC_CHECK_MMU_INIT    _IOR(HX170DEC_IOC_MAGIC, 9, unsigned int *)
#define VDEC_NOTIFY_HW_ENABLE      _IO(HX170DEC_IOC_MAGIC, 10)
#define VDEC_NOTIFY_HW_DISABLE     _IO(HX170DEC_IOC_MAGIC, 11)
#define HX170DEC_RESET             _IO(HX170DEC_IOC_MAGIC, 12)
#define HX170DEC_UPDATE_CLK        _IO(HX170DEC_IOC_MAGIC, 13)
#define HX170DEC_GETDVFS           _IOR(HX170DEC_IOC_MAGIC, 14, unsigned int *)

#define HX170DEC_IOC_MAXNR 14
