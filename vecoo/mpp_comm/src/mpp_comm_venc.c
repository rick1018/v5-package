...
static VENC_CFG_S g_cfg_1920_to_1920_16M_30fps = {
    .src_width      = 1920,
    .src_height     = 1920,
    .dst_width      = 1920,
    .dst_height     = 1920,
...
int mpp_comm_venc_get_cfg(VENC_CFG_TYPE_E venc_type, VENC_CFG_S *p_venc_cfg)
{
    ...
    switch (venc_type)
    {
        ...
        case VENC_2048x2048_TO_2048x2048_10M_30FPS:
            ...
            break;
        case VENC_1920x1920_TO_1920x1920_16M_30FPS:
            memcpy(p_venc_cfg, &g_cfg_1920_to_1920_16M_30fps, sizeof(VENC_CFG_S));
            break;
