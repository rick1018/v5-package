...
typedef enum tag_MPP_COM_VI_TYPE_E {
    ...
    VI_1920x1920_30FPS, /* for ise fish */
...
typedef enum tag_VENC_CFG_TYPE_E {
    ...
    VENC_1920x1920_TO_1920x1920_16M_30FPS,
...
typedef enum tag_ISE_MODE_CFG_E {
    ...
    ISE_FISH_TOP_4PTZ_MODE_GRP0_1920_TO_960x960,
    ISE_FISH_TOP_4PTZ_MODE_GRP1_1920_TO_960x960,
    ISE_FISH_TOP_4PTZ_MODE_GRP2_1920_TO_960x960,
    ISE_FISH_TOP_4PTZ_MODE_GRP3_1920_TO_960x960,
