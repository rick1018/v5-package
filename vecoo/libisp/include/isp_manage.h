...
struct isp_ae_stats_s {
	HW_U64 win_pix_n;
	HW_U64 accum_r[ISP_AE_ROW][ISP_AE_COL];
	HW_U64 accum_g[ISP_AE_ROW][ISP_AE_COL];
	HW_U64 accum_b[ISP_AE_ROW][ISP_AE_COL];
	HW_U32 avg_max[ISP_AE_ROW*ISP_AE_COL];
...
struct isp_awb_stats_s {
	HW_U64 awb_sum_r[ISP_AWB_ROW][ISP_AWB_COL];
	HW_U64 awb_sum_g[ISP_AWB_ROW][ISP_AWB_COL];
	HW_U64 awb_sum_b[ISP_AWB_ROW][ISP_AWB_COL];
	HW_U64 awb_sum_cnt[ISP_AWB_ROW][ISP_AWB_COL];
...
struct isp_md_stats_s {
	HW_U32 win_pix_n;
	HW_U32 accum_md[ISP_MD_ROW][ISP_MD_COL];
};

struct isp_gtm_stats_s {
	HW_U64 win_pix_n;
	HW_U32 avg[ISP_GTM_ROW * ISP_GTM_COL];
	HW_U32 hist[ISP_HIST_NUM];
};

struct isp_pltm_stats_s {
	HW_U64 win_pix_n;
	HW_U32 lst[ISP_PLTM_ROW * ISP_PLTM_COL];
};
...
struct isp_lib_context {
	...
	HW_U8 isp0_stat_buf[ISP_STAT_TOTAL_SIZE];
	HW_U8 isp1_stat_buf[ISP_STAT_TOTAL_SIZE];
	void *load_reg_base;
};
