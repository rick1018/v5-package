...
从命令行启动sample_ai的指令：
	./sample_ai2aenc2muxer -path /mnt/SDCARD/sample_ai2aenc2muxer/sample_ai2aenc2muxer.conf
	"-path /mnt/SDCARD/sample_ai2aenc2muxer/sample_ai2aenc2muxer.conf"指定了测试参数配置文件的路径。
