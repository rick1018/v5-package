...
从命令行启动sample_demux2adec2ao的指令：
	./sample_demux2adec2ao -path /mnt/SDCARD/sample_demux2adec2ao/sample_demux2adec2ao.conf
	"-path /mnt/SDCARD/sample_demux2adec2ao/sample_demux2adec2ao.conf"指定了测试参数配置文件的路径。
